...
// Source File Name:   XML4JDOMAdapter.java
...
public class XML4JDOMAdapter extends AbstractDOMAdapter
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            setFeature.invoke(parser, new Object[] {
                "http://xml.org/sax/features/namespaces", new Boolean(false)
            });
            if(validate)
            {
    ...
    private static final String CVS_ID = "@(#) $RCSfile: XML4JDOMAdapter.java,v $ $Revision: 1.1 $ $Date: 2006/02/28 01:59:32 $ $Name:  $";
}
