...
public class UserIterator implements Iterator {
	private static final String ALLOBJ = "SELECT * FROM " + User.TABLENAME;
	 ...
	 */
	public static UserIterator findBySQL(String sql) throws SystemException {
		...
		try {
			...
			System.err.println("SQLException in UserIterator(String): " + sqle);
		} catch (Exception e) {
			System.err.println("Exception in UserIterator(String): " + e);
		} finally {
	...
	*/
	public UserIterator(String conditionStr) throws SystemException {
		ArrayList temp = new ArrayList();
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			errorStr = "SQLException in UserIterator:constructor()-" + sqle;
			throw new SystemException(this, errorStr);
		} catch (Exception exception) {
			errorStr = "Exception in UserIterator:" + exception;
			throw new SystemException(this, errorStr);
		} finally {
			DbConnectionManager.close(con, pstmt, null, rs);
	...
	* @throws SystemException 将错误写入到系统日志
	*/
	public UserIterator(String conditionStr, int startIndex, int num)
	...
	public Object next() {
		...
		currentIndex++;
		try {
			user = UserHome.findById(objs[currentIndex]);
		} catch (Exception e) {
